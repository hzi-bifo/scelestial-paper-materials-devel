...
$SCRIPT/test-gen-eval-all.sh $DIR/$OP -rep $LEN -mut 10 10.01 4 -ozr $OZ_OPT -zor $ZO_OPT -mvr $MV_OPT -locus $LOC_OPT -sample $SAMPLE_OPT -clone 0 9 1 -step 5 5 1 -gen synth -run2 $RUN2 -keep -exit-on-error-no -cpu-limit -alg-parallel &>$DIR/$OP/$OUTPUT.eo
